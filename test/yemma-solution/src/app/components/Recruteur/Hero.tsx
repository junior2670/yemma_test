    ...
    <div className="mt-[80px] max-md:mt-[50px] flex justify-center items-center min-h-[500px] md:min-h-[579px] px-4 py-6 md:py-8 bg-gray-50/50">
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <br className="hidden lg:hidden   sm:block"/> 
               ...
               <Typewriter
                    words={[' Chasse ciblée pour vos besoins rares ou stratégiques',
                         ' Accès à des profils locaux internationaux et issus de la diaspora',
          ...
          >
            Nous allions la technologie, la compréhension métier et  <br className="hidden  xl:block"/>
            l’intelligence humaine pour vous aider à recruter mieux et plus  <br className="hidden  xl:block"/>
            vite.
          </motion.p>
          ...
          >
            ...
            >
              Accès à la CVthèque
                ...
                <motion.a 
                href="" 
                className="text-black flex items-center space-x-[5px] bg-orange-100/20 max-sm:text-[12px]  border-2 border-orange-700 p-3 px-5 text-center whitespace-nowrap hover:opacity-90 transition-opacity w-full sm:w-auto md:w-[200px] lg:w-auto rounded-sm"
                variants={buttonVariants}
                whileHover="hover"
                whileTap="tap"
                >
